...
public class ServiceTest {
    ...
    public void test_mapping_normalItem() {
        Items elixir = em.find(Items.class, "Elixir of the Mongoose");
	...
	public void test_carga_item() {
        Assertions.assertThat(servicio).isNotNull();
		Items item = servicio.cargaItem("Elixir of the Mongoose");
	...
	public void test_carga_item_no_existe() {
        Assertions.assertThat(servicio).isNotNull();
		Items item = servicio.cargaItem("Reliquias de la muerte");
		Assertions.assertThat(item).isNotNull();
	...
	public void test_comanda_ok() {
		...
		Assertions.assertThat(orden.getOrd_id()).isNotZero();
		...
		em.find(Orden.class, pedidos.get(1).getOrd_id()).delete();
	}
	...
	public void test_ordenar_multiples_items_ok() {
		...
		em.find(Orden.class, pedidos.get(2).getOrd_id()).delete();
		em.find(Orden.class, pedidos.get(1).getOrd_id()).delete();
	}
